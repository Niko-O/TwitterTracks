Public Class OpenTweetInformation
    ...
    Public Class TwitterConnectionContianer
        ...
        Public Function ToAuthenticationToken() As TwitterTracks.Gathering.TweetinviInterop.AuthenticationToken
            Return New TwitterTracks.Gathering.TweetinviInterop.AuthenticationToken(ConsumerKey, ConsumerSecret, AccessToken, AccessTokenSecret)
        End Function
    End Class
