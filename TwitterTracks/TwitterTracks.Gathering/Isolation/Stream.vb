...
Public Class Stream
    ...
    Public Event Stopped As EventHandler(Of TwitterTracks.Gathering.TweetinviInterop.StreamStoppedEventArgs)
    Protected Overridable Sub OnStopped(e As TwitterTracks.Gathering.TweetinviInterop.StreamStoppedEventArgs)
    ...
    Private Sub Stream_DisconnectMessageReceived(sender As Object, e As Tweetinvi.Events.DisconnectedEventArgs) Handles Stream.DisconnectMessageReceived
        ...
        OnStopped(TwitterTracks.Gathering.TweetinviInterop.StreamStoppedEventArgs.Disconnect(e.DisconnectMessage.Code, e.DisconnectMessage.Reason, e.DisconnectMessage.StreamName))
    End Sub
    ...
    Private Sub Stream_LimitReached(sender As Object, e As Tweetinvi.Events.LimitReachedEventArgs) Handles Stream.LimitReached
        ...
        OnStopped(TwitterTracks.Gathering.TweetinviInterop.StreamStoppedEventArgs.LimitReached(e.NumberOfTweetsNotReceived))
    End Sub
    ...
    Private Sub Stream_StreamStopped(sender As Object, e As Tweetinvi.Events.StreamExceptionEventArgs) Handles Stream.StreamStopped
        If e.DisconnectMessage Is Nothing Then
            ...
            OnStopped(TwitterTracks.Gathering.TweetinviInterop.StreamStoppedEventArgs.Stopped(e.Exception, -1, Nothing, Nothing))
        Else
            ...
            OnStopped(TwitterTracks.Gathering.TweetinviInterop.StreamStoppedEventArgs.Stopped(e.Exception, e.DisconnectMessage.Code, e.DisconnectMessage.Reason, e.DisconnectMessage.StreamName))
        End If
    End Sub
