Public Structure TrackMetadata
    ...
    Private _RelevantHashtags As System.Collections.ObjectModel.ReadOnlyCollection(Of String)
    Public ReadOnly Property RelevantHashtags As System.Collections.ObjectModel.ReadOnlyCollection(Of String)
        <DebuggerStepThrough()>
        Get
            Return _RelevantHashtags
        End Get
    End Property

    Public Sub New(NewInitialTweetId As Int64, NewInitialTweetUserId As Int64, NewInitialTweetFullText As String, NewRelevantHashtags As IEnumerable(Of String))
        _InitialTweetId = NewInitialTweetId
        _InitialTweetUserId = NewInitialTweetUserId
        _InitialTweetFullText = NewInitialTweetFullText
        _RelevantHashtags = New System.Collections.ObjectModel.ReadOnlyCollection(Of String)(New List(Of String)(NewRelevantHashtags))
    End Sub
